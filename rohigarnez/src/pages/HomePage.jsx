    ...
    const fetchAll = async () => {
      try {
        const [pageRes, testRes] = await Promise.all([
          fetch(`${import.meta.env.VITE_API_URL}/api/info/homepage`),
          fetch(`${import.meta.env.VITE_API_URL}/api/testimonials/testimonials-homepage`)
        ]);
