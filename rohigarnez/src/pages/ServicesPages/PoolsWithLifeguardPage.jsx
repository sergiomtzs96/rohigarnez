...
import { Shield, Eye, Heart, FileText, Users } from 'lucide-react';
import { Button } from '../../components/ui/button';

export default function PoolsLifeguardPage({ onNavigate }) {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `${import.meta.env.VITE_API_URL}/api/services/poolswithlifeguardpage`
        )
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="grid grid-cols-1 border-t border-l border-[#141516]/10">
                {data?.content?.lifeguardServices?.map((service, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-start gap-6 p-8 border-b border-r border-[#141516]/10 hover:bg-gray-50 transition-colors group">
                      <div className="mt-1">
                        {Icon && <Icon className="w-6 h-6 text-[#70a2ad] stroke-[1.5] group-hover:scale-110 transition-transform duration-300" />}
                      </div>
                      <div>
            ...
            <div className="lg:col-span-5">
              <div className="bg-[#f8f9fa] border border-[#141516]/5 sticky top-8">
                ...
                <div className="grid grid-cols-1">
                  {data?.content?.regulations?.map((reg, index) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border-l border-[#141516]/10">
            {data?.content?.packages.map((pkg, index) => (
