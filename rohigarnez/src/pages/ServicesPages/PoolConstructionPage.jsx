...
import { CheckCircle, Award, Clock, Settings, DraftingCompass, Truck, BrickWall, Sparkles } from 'lucide-react';
import { Button } from '../../components/ui/button';


export default function PoolConstructionPage({ onNavigate }) {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `${import.meta.env.VITE_API_URL}/api/services/poolconstructionpage`
        )
            ...
            <div className="lg:col-span-5">
              ...
              <div className="bg-[#f8f9fa] p-8 border border-[#141516]/5">
                ...
                <ul className="space-y-4">
                  {data?.content?.features?.map((feat, i) => (
                      ...
                      <div className="flex flex-col md:flex-row gap-4 md:items-start justify-between group-hover:translate-x-2 transition-transform duration-300">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            {Icon && <Icon className="w-5 h-5 text-[#70a2ad] stroke-[1.5]" />}
      ...
      <section className="py-24 bg-[#f8f9fa] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-[#141516]/10 bg-white">
            {data?.content?.finishes?.map((finish, index) => (
          ...
          <div className="mt-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#141516]/10 border border-[#141516]/10">
              {data?.content?.extras?.map((extra, index) => (
